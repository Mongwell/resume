...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\huge Maanu Grover} & {mgrover3@illinois.edu} \\
  \textbf & 630-258-9190 \\
...
{University of Illinois at Urbana-Champaign}{GPA: 3.58/4.00}
...
{Algorithms \& Models of Computation, Data Structures, Advanced Distributed Systems, Applied Parallel Programming, System Programming, Database Systems, Computer Security,  Languages \& Compilers}
...
\hfill
\item[]\small{
	\textbf{Tools/Technologies}{: Git, Docker, AWS, Flask, ViM}
}
\end{multicols}
\resumeSubHeadingListEnd
