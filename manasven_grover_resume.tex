...
\item[]\small{
	\textbf{Tools/Technologies}{: Git, Docker, Kubernetes, Flask}
}
\end{multicols}
\resumeSubHeadingListEnd
...
\resumeSubheadingDetailed{IBM}{Durham, NC}{DevOps Engineer}{May 2021 - Present}
\resumeItemListStart
\resumeBullet{Work in an agile, collaborative environment to build, deploy, configure, maintain systems, which include software installations, updates, and core services, onto OpenShift Container Platform or other Kubernetes-based clusters}
\resumeBullet{Design and implement tools for automated deployment and monitoring of multiple environments}
\resumeBullet{Work with several development teams to enable the configuration of an edge computing distributed framework consisting of a management hub cluster and remote instances to which workloads are deployed}
%\resumeBullet{Work with development teams to enable a continuous integration environment that sustains high productivity levels and emphasizes defect prevention techniques}
%\resumeBullet{Ensures delivery pipeline from dev/test, staging and production and perform A/B testing}

\resumeBullet{Automate, measure and optimize system performance, security, and processes}
\resumeItemListEnd
